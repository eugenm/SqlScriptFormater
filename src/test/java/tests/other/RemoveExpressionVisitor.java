 ...
 * @author Eugen
 */
class RemoveExpressionVisitor implements ExpressionVisitor {

    RemoveCheck columnCheck;

    RemoveExpressionVisitor(RemoveCheck columnCheck) {
    ...
    public void visit(SubSelect subSelect) {
        ...
        subSelect.getSelectBody().accept(removeSelectVisitor);
    }
